...
from music_app.views import LandingPageView, ArtistListView, ArtistCreateView, SongCreateView, SongListView, SongUpdateView, deleteSong

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', LandingPageView.as_view(), name='home'),
    path('artists', ArtistListView.as_view(), name='artists'),
    path('add_artists', ArtistCreateView.as_view(), name='add_artist'),
